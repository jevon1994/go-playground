...
type GreeterClient interface {
	Test(ctx context.Context, in *CloudEvent, opts ...grpc.CallOption) (*GreeterResponse, error)
}
...
func (c *greeterClient) Test(ctx context.Context, in *CloudEvent, opts ...grpc.CallOption) (*GreeterResponse, error) {
	out := new(GreeterResponse)
	err := c.cc.Invoke(ctx, "/api.v1.Greeter/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	Test(context.Context, *CloudEvent) (*GreeterResponse, error)
}
...
func (UnimplementedGreeterServer) Test(context.Context, *CloudEvent) (*GreeterResponse, error) {
...
func _Greeter_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v1.Greeter/Test",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Test(ctx, req.(*CloudEvent))
	}
