...
var file_examples_features_proto_echo_echo_proto_goTypes = []interface{}{
	(*EchoRequest)(nil),  // 0: rk-grpc.examples.echo.EchoRequest
	(*EchoResponse)(nil), // 1: rk-grpc.examples.echo.EchoResponse
}
var file_examples_features_proto_echo_echo_proto_depIdxs = []int32{
	0, // 0: rk-grpc.examples.echo.Echo.UnaryEcho:input_type -> rk-grpc.examples.echo.EchoRequest
	0, // 1: rk-grpc.examples.echo.Echo.ServerStreamingEcho:input_type -> rk-grpc.examples.echo.EchoRequest
	0, // 2: rk-grpc.examples.echo.Echo.ClientStreamingEcho:input_type -> rk-grpc.examples.echo.EchoRequest
	0, // 3: rk-grpc.examples.echo.Echo.BidirectionalStreamingEcho:input_type -> rk-grpc.examples.echo.EchoRequest
	1, // 4: rk-grpc.examples.echo.Echo.UnaryEcho:output_type -> rk-grpc.examples.echo.EchoResponse
	1, // 5: rk-grpc.examples.echo.Echo.ServerStreamingEcho:output_type -> rk-grpc.examples.echo.EchoResponse
	1, // 6: rk-grpc.examples.echo.Echo.ClientStreamingEcho:output_type -> rk-grpc.examples.echo.EchoResponse
	1, // 7: rk-grpc.examples.echo.Echo.BidirectionalStreamingEcho:output_type -> rk-grpc.examples.echo.EchoResponse
